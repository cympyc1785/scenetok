...
gpus=1
num_nodes=1
exp_name="va-wan-ti2v_recon_aggressive_train_256-480_finetuned_controlnet_feedback_text_small_no_cfg"
...
CUDA_VISIBLE_DEVICES=2 exec -a dynamic_scenetok_lets_go python -m src.main +experiment=${config} \
  ...
  model.denoiser.scene_input_type=controlnet \
  model.denoiser.condition_latents_input_type=none \
  model.denoiser.camera_input_type=controlnet_feedback \
