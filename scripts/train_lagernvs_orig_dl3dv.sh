...
# Logs/ckpts -> my_checkpoints/<exp>/ (TensorBoard + wandb, val 영상 로깅).
set -e
...
export WANDB_PROJECT=${WANDB_PROJECT:-lagernvs-repro}
export WANDB_MODE=${WANDB_MODE:-online}
export TMPDIR=/NHNHOME/WORKSPACE/0226010013_A/cympyc1785/scenetok/.pip_tmp
