...
gpus=1
num_nodes=1
exp_name="va-wan-ti2v_recon_aggressive_train_256-480_finetuned_scene_new_ca_recam_depth_first_frame_small"
...
CUDA_VISIBLE_DEVICES=2 exec -a dynamic_scenetok_lets_go python -m src.main +experiment=${config} \
  ...
  model.denoiser.condition_latents_input_type=first_frame_depth \
