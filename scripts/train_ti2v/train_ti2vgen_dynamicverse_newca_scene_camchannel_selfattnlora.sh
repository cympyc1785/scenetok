...
gpus=1
num_nodes=1
# compressor를 unscaled-trained ckpt로 교체 (dynamicverse normalized intrinsic in-distribution). exp_name += _unscaledcomp.
compressor_ckpt=checkpoints/va-wan_dl3dv_256-480_unscaled_intrins.ckpt
exp_name="va-wan-ti2v_dynamicverse_dynamic_newca_scene_camchannel_selfattnlora_unscaledcomp"
