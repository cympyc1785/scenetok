...
# Same controlnet (parallel) setting, no_lora, but with ac3d_num_layers=6
# (vs default 2). AC3D-paper ratio (8/42 ≈ 19%) → Wan 30 layers × 19% ≈ 6.
# GPU 1.
...
wandb_tags='[dynamicverse,wan-ti2v,controlnet,scene+camera,video_input,category,layer_6]'

export WANDB_API_KEY=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
export DEBUG=1

CUDA_VISIBLE_DEVICES=1 exec -a layer_6_scenetok_lets_go python -m src.main +experiment=${config} \
