...
gpus=1
num_nodes=1
exp_name="va-wan-ti2v_recon_aggressive_train_256-480_finetuned_scene_new_ca_ac3d_large"
...
CUDA_VISIBLE_DEVICES=1 exec -a dynamic_scenetok_lets_go python -m src.main +experiment=${config} \
  ...
  model.denoiser.camera_input_type=controlnet \
  +model.denoiser.ac3d_num_layers=2 \
