#!/usr/bin/env bash
# Variant of train_ti2vgen_dynamicverse_controlnet_dynamic_no_lora_layer_6.sh:
# ac3d_num_layers=4 (layer_6은 step ~1000 warmup 끝나며 발산 → 더 얕게 시도).
# GPU 1.
...
gpus=1
num_nodes=1
exp_name="va-wan-ti2v_dynamicverse_dynamic_controlnet_scene_camera_2_no_lora_layer_4"
...
wandb_tags='[dynamicverse,wan-ti2v,controlnet,scene+camera,video_input,category,layer_4]'

export WANDB_API_KEY=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
export DEBUG=1

CUDA_VISIBLE_DEVICES=1 exec -a layer_4_scenetok_lets_go python -m src.main +experiment=${config} \
