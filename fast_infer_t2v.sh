...
# exp_name="exp_va-wan_t2v_recon_train_cam_ca_scene_ca_lora_overfit"
# exp_name="va-wan-ti2v_recon_aggressive_train_256-480_finetuned_controlnet_text_small_no_cfg"
...
export DEBUG=1
CUDA_VISIBLE_DEVICES=0 exec -a infer_scenetok python "${ROOT_DIR}/scripts/fast_infer_t2v.py" \
  --exp_name "${exp_name}" \
  --scene_id "${scene_id}" \
