#!/usr/bin/env bash
# Same as infer_pure_ti2v.sh but force fp32 throughout (FORCE_FP32 hook + trainer.precision=32-true).
set -e
ROOT_DIR=/NHNHOME/WORKSPACE/0226010013_A/cympyc1785/scenetok/
config=custom/scenetok_va-wan-ti2v_dl3dv
exp_name="pure_ti2v_fp32"
...
export DEBUG=1
export FORCE_FP32=1
export INJECT_NOISE_PATH=/tmp/diffsynth_noise_fp32.pt
