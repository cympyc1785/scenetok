...
gpus=1
num_nodes=1
exp_name="va-wan-ti2v_recon_aggressive_train_480-480_finetuned_scene_new_ca_recam_small"
...
CUDA_VISIBLE_DEVICES=2 exec -a dynamic_scenetok_lets_go python -m src.main +experiment=${config} \
  ...
  model.compressor.ckpt_path=checkpoints/va-wan_dl3dv_480x832.ckpt \
